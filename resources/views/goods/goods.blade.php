    ...
    <div id="page-infinite-scroll-bottom" class="page">
        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                <ul class="list"><li sortid='0' class='current'><span id="items"><a href="goods">全部商品</a></span></li></ul>
                <ul id="sortListUl" class="list">
                    @foreach($info as $v)
                        <li sortid='100' reletype='1' linkaddr=''><span class='items' cate_id="{{$v->cate_id}}">{{$v->cate_name}}</span></li>
                        @endforeach
                </ul>
            </div>
            ...
            <div class="good-list-wrapper">
                ...
                <div class="good-list-inner">
                    <div id="pullrefresh" class="good-list-box  mui-content mui-scroll-wrapper">
                        <div class="goodList mui-scroll" id="list_div">
                            <ul id="ulGoodsList" class="mui-table-view mui-table-view-chevron">
                                ...
                                <li id="23468">
                                    ...
                                    <span class="gList_l fl">
                                        <img class="lazy" data-original="https://img.1yyg.net/GoodsPic/pic-200-200/20160908104402359.jpg"  src="/images/uploads/uploads/{{$v->goods_img}}">
                                    </span>
                                    <div class="gList_r">
                                        <h3 class="gray6"><a href="shopcontent?goods_id={{$v->goods_id}}">{{$v->goods_name}}(第17094云)苹果（Apple）iPhone 7 Plus 256G版 4G手机 </a></h3>
...
<script>
    ...
    $('#sortListUl li').click(function(){
        ...
        var cate_id=$(this).children().attr('cate_id');
        var data={};

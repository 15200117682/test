...
<div class="marginB" id="loadingPicBlock">
    ...
    <div class="hot-wrapper">
        <ul class="clearfix">
            ...
            <li style="border-right:1px solid #e4e4e4; ">
                <a href="">
                    <p class="title">{{$v->brand_name}}</p>
                    <p class="subtitle">{{$v->brand_describe}}</p>
    ...
    <div class="goods-wrap marginB" id="div_img">
        <ul class="goods-list clearfix" id="ulGoodsList">
    ...
    <div id="div_fastnav" class="fast-nav-wrapper">
        ...
        <div class="sub-nav four" style="display: none;">
            ...
            <a href="javascript:;" id="chaogou"><i class="personal"></i>我的潮购</a>

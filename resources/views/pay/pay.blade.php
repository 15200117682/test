...
<div class="userinfo">
    ...
    <div class="express-bottom">
        <ul class="clearfix">
            ...
            <li class="info">
                <div class="clearfix">
                    <span class="user fl">收货人：{{$info->order_receive_name}}</span>
                    <span class="tel fr">{{$info->receive_phone}}</span>
                </div>
                <p>{{$info->receive_address}}</p>
            </li>
            <a href="address" style="float: right;font-size:50px;">> </a>
        </ul>
    </div>
</div>
<div>
    <div class="g-pay-lst">
                ...
                <a href="">
                    ...
                    <dl>
                        <dt>
                            ...
                            (第{{$v->goods_sn}}潮){{$v->goods_name}}
                        </dt>
                        <dd><em class="price">{{$v->buy_number}}</em>人次/<em>￥{{$v->goods_price}}</em></dd>
                    </dl>
                </a>
            </li>
                @endforeach
        ...
        <p>总需支付金额：<em class="orange"><i>￥</i>1.00</em></p>
    </div>

...
<form class="layui-form" action="">
    <div class="addrcon">
        <ul>
            <li><em>收货人</em><input type="text" id="order_receive_name" placeholder="请填写真实姓名"></li>
            <li><em>手机号码</em><input type="number" id="receive_phone" placeholder="请输入手机号"></li>
    ...
    $(function () {
        layui.use(['layer'],function() {
            ...
            $(".m-index-icon").click(function () {
                //传值
                var order_receive_name=$('#order_receive_name').val();
                var receive_phone=$('#receive_phone').val();
                var receive_address=$('#demo1').val()+$('.addr').val();
                var data={};
                data.order_receive_name=order_receive_name;
                data.receive_phone=receive_phone;
